...
public class DocumentsView extends VerticalLayout {
    ...
    public DocumentsView(ZatrudnienieService zatrudnienieService, EatFirmaService eatFirmaService) throws ParseException {
    ...
    private void genPDF(Zatrudnienie zat){
        ...
        report.getReportBuilder().setMargins(20, 3, 40, 40)
                ...
                .addAutoText("", AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 500, headerStyle)
                .addAutoText("", AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 500, headerStyle)
                .addAutoText("Obowiązuje Panią/Pana : 8 godzinna / 7 godzinna dobowa norma czasu pracy i przeciętnie 40 godzinna/", AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 500, headerStyle)

                .addAutoText("35 godzinna tygodniowa norma czasu pracy w przeciętnie 5- dniowym tygodniu pracy w okresie rozliczeniowym. ", AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 500, headerStyle)
                ...
                .addAutoText("  - dodatkowa przerwa z tytułu posiadania orzeczenia o stopniu niepełnosprawności: 15 min (dla osób ", AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 500, headerStyle)
                .addAutoText("niepełnosprawnych po kodzie ubezpieczenia z umowy)", AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 500, headerStyle)
                ...
                .addAutoText("", AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 500, headerStyle)
                .addAutoText("Wymiar przysługującego Ci urlopu dodatkowego: ……………………(tylko dla NP. po kodzie ubezpieczenia)", AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 500, headerStyle)
                .addAutoText("Ilość dni do wykorzystania w 20… roku: …………………", AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 500, headerStyle)

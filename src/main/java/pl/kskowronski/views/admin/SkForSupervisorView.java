...
public class SkForSupervisorView extends Div {
    ...
    private void setupDataProvider() {
        pl.kskowronski.component.SkForSupervisorDataProvider dataProvider = new pl.kskowronski.component.SkForSupervisorDataProvider(nppSkForSupervisorService, skService, userService);
